...
function PrivacyPolicy(props) {
  return (
    <Container className="py-4">
      <h1 className="text-center">Welcome to our Privacy Policy </h1>{" "}
      <h3 className="text-center">Your privacy is critically important to us. </h3>
      <h5 className="text-center">Sympto + Map is located at:</h5>
      <address className="text-center">
				1501 Brookwood Drive Iowa City <br></br> 52240 - IA,
        United States <br></br> 319-400-4404{" "}
      </address>
      <p>
        {" "}
        It is Sympto + Map 's policy to respect your privacy regarding any
        information we may collect while operating our website. This Privacy
        Policy applies to{" "}
        <a href="https://www.sympto-map.com">https://www.sympto-map.com</a>{" "}
        (hereinafter, "us", "we", or "https://www.sympto-map.com"). We respect
      ...
      <p>
        {" "}
        Like most website operators, Sympto + Map collects non - personally -
        ...
        referring site, and the date and time of each visitor request.Sympto +
        Map 's purpose in collecting non-personally identifying information is
        to better understand how Sympto+Map' s visitors use its website.From
        time to time, Sympto + Map may release non - personally - identifying
        information in the aggregate, e.g., by publishing a report on trends in
        the usage of its website.{" "}
      </p>{" "}
      <p>
        {" "}
        Sympto + Map also collects potentially personally - identifying
        information like Internet Protocol(IP) addresses for logged in users and
        for users leaving comments on https: //www.sympto-map.com blog posts.
        Sympto+Map only discloses logged in user and commenter IP addresses
      ...
      <p>
        {" "}
        Certain visitors to Sympto + Map 's websites choose to interact with
        Sympto+Map in ways that require Sympto+Map to gather
        personally-identifying information. The amount and type of information
        that Sympto+Map gathers depends on the nature of the interaction. For
        example, we ask visitors who sign up for a blog at
        https://www.sympto-map.com to provide a username and email address.
      </p>
      <h2> Security </h2>{" "}
      <p>
        {" "}
      ...
      <p>
        ...
        Privacy Policy covers the use of cookies by Sympto + Map and does not
      ...
      <h2> Https: //www.sympto-map.com uses Google AdWords for remarketing</h2>
      <p>
        {" "}
        Https: //www.sympto-map.com uses the remarketing services to advertise
      ...
      <p>
        {" "}
        Sympto + Map discloses potentially personally - identifying and
        personally - identifying information only to those of its employees,
        contractors and affiliated organizations that(i) need to know that
        information in order to process it on Sympto + Map 's behalf or to
        provide services available at Sympto+Map' s website, and(ii) that have
        ...
        country; by using Sympto + Map 's website, you consent to the transfer
        of such information to them. Sympto+Map will not rent or sell
        ...
        affiliated organizations, as described above, Sympto+Map discloses
        potentially personally-identifying and personally-identifying
        information only in response to a subpoena, court order or other
        governmental request, or when Sympto+Map believes in good faith that
        disclosure is reasonably necessary to protect the property or rights of
        Sympto+Map, third parties or the public at large.
      </p>{" "}
      <p>
        {" "}
        If you are a registered user of https: //www.sympto-map.com and have
        supplied your email address, Sympto+Map may occasionally send you an
        email to tell you about new features, solicit your feedback, or just
        keep you up to date with what's going on with Sympto+Map and our
        ...
        users. Sympto+Map takes all measures reasonably necessary to protect
      ...
      <p>
        {" "}
        Sympto + Map may collect statistics about the behavior of visitors to
        its website.Sympto + Map may display this information publicly or
        provide it to others.However, Sympto + Map does not disclose your
      ...
      <p>
        {" "}
        To enrich and perfect your online experience, Sympto + Map uses
      ...
      <p>
        ...
        's computer, and that the visitor' s browser provides to the website
        each time the visitor returns.Sympto + Map uses cookies to help Sympto +
        Map identify and track visitors, their usage of https:
        //www.sympto-map.com, and their website access preferences. Sympto+Map
        visitors who do not wish to have cookies placed on their computers
        should set their browsers to refuse cookies before using Sympto+Map's
        websites, with the drawback that certain features of Sympto+Map's
        websites may not function properly without the aid of cookies.
      </p>
      <p>
        {" "}
        By continuing to navigate our website without changing your cookie
        settings, you hereby acknowledge and agree to Sympto + Map 's use of
        cookies.
      </p>
      <h2> Privacy Policy Changes </h2>{" "}
      <p>
        {" "}
        Although most changes are likely to be minor, Sympto + Map may change
        its Privacy Policy from time to time, and in Sympto + Map 's sole
        discretion. Sympto+Map encourages visitors to frequently check this page
      ...
      <p>
        ...
        via <a href="mailto:sympto.map.management@gmail.com">email</a> or{" "}
        <a href="tel:3194004404"> phone </a>.
      </p>
    </Container>
  );
}
